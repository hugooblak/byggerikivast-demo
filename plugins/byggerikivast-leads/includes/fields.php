...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'byggerikivast-leads' ),
				'storm'       => __( 'Storm or hail damage', 'byggerikivast-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'byggerikivast-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'byggerikivast-leads' ),
				'not-sure'    => __( 'Vet inte än', 'byggerikivast-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'byggerikivast-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'byggerikivast-leads' ),
				'research' => __( 'Jag kollar bara priser', 'byggerikivast-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'byggerikivast-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'byggerikivast-leads' ),
		'contacted' => __( 'Kontaktad', 'byggerikivast-leads' ),
		'quoted'    => __( 'Quote sent', 'byggerikivast-leads' ),
		'won'       => __( 'Won', 'byggerikivast-leads' ),
		'lost'      => __( 'Lost', 'byggerikivast-leads' ),
		'spam'      => __( 'Misstänkt spam', 'byggerikivast-leads' ),
	);
}
