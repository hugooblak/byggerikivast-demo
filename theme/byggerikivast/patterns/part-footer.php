...
/**
 * Title: Part: sidfot
 * Slug: byggerikivast/part-footer
 * Inserter: no
 *
...
<p class="has-text-align-center by-footer-note has-small-font-size" style="margin-top:var(--wp--preset--spacing--50)">Bygg-Erik i Väst AB AB · Demosajt byggd som förslag. Bilder och omdömen är platshållare.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
