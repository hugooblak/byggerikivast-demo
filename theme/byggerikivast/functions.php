<?php
/**
 * Bygg-Erik i Väst AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Bygg-Erik i Väst AB Leads" plugin, so leads survive a theme change.
 *
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'byggerikivast', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'byggerikivast' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'byggerikivast' ) ) );

		register_block_pattern_category( 'byggerikivast-sections', array( 'label' => __( 'Bygg-Erik i Väst AB sections', 'byggerikivast' ) ) );
		register_block_pattern_category( 'byggerikivast-pages', array( 'label' => __( 'Bygg-Erik i Väst AB page layouts', 'byggerikivast' ) ) );
	}
);
